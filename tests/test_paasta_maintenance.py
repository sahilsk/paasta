...
from paasta_tools.paasta_maintenance import get_hosts_in_maintenance_window
...
@mock.patch('paasta_tools.paasta_maintenance.get_hosts_in_maintenance_window')
def test_is_safe_to_kill(
    mock_get_hosts_in_maintenance_window,
    mock_is_host_drained,
):
    mock_is_host_drained.return_value = False
    mock_get_hosts_in_maintenance_window.return_value = []
    assert not is_safe_to_kill('blah')

    mock_is_host_drained.return_value = False
    mock_get_hosts_in_maintenance_window.return_value = ['blah']
...
def test_get_hosts_in_maintenance_window(
    ...
    ret = get_hosts_in_maintenance_window()
    assert ret == ['host2']
